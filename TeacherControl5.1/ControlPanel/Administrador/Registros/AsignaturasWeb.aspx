<%@ Page Title="" Language="C#" MasterPageFile="~/AdministradoresSite.Master" AutoEventWireup="true" CodeBehind="AsignaturasWeb.aspx.cs" Inherits="TeacherControl5._1.ControlPanel.Administrador.Registros.AsignaturasWeb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="El campo &quot;Creditos&quot; es obligatorio." ForeColor="Red" ControlToValidate="CreditosTextBox">*</asp:RequiredFieldValidator>
    <br />
