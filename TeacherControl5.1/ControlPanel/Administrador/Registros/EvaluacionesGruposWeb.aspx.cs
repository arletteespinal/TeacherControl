    ...
    public partial class EvaluacionesGruposWeb : System.Web.UI.Page
    {
        ...
        protected void AgregarButton_Click(object sender, EventArgs e)
        {
            ...
            if (CodigoTextBox.Text == string.Empty)
            {
                ...
                evaluaciones.agregarDetalle(DescripcionTextBox.Text, DateTime.Now.ToString(), FechaEntregaTextBox.Text, Convert.ToInt32(TipoAsignacionDropDownList.SelectedValue.ToString()), Convert.ToInt32(PonderacionTextBox.Text), Convert.ToInt32(EstatusDropDownList.SelectedIndex));
