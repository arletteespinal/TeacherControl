...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="BuscarButton" runat="server" Text="Buscar" OnClick="BuscarButton_Click"  CausesValidation="false" Height="27px"/>
    <br />
   ...
   <br />
    ...
    <asp:TextBox ID="FechaInicioTextBox" runat="server"  CssClass="datepicker" ReadOnly="True"></asp:TextBox>
    ...
    <asp:TextBox ID="FechaFinTextBox" runat="server"  CssClass="datepicker" ReadOnly="True"></asp:TextBox>
