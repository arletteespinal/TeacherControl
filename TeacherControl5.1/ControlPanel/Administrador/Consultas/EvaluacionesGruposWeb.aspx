<%@ Page Title="" Language="C#" MasterPageFile="~/AdministradoresSite.Master" AutoEventWireup="true" CodeBehind="EvaluacionesGruposWeb.aspx.cs" Inherits="TeacherControl5._1.ControlPanel.Administrador.Consultas.EvaluacionesGruposWeb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <asp:GridView ID="EvaluacionesGruposGridView" runat="server">
        <Columns>
