...
namespace TeacherControl5._1.ControlPanel.Administrador.Consultas
{
    public partial class TiposEvaluacionesWeb : System.Web.UI.Page
    {
        ...
        protected void FiltarDropDownList_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (FiltarDropDownList.SelectedIndex == 0)
            {
                EstatusCheckBox.Visible = false;
            }
            if (FiltarDropDownList.SelectedIndex == 1)
            {
                EstatusCheckBox.Visible = true;
            }
        }
