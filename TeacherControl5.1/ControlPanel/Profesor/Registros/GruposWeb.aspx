...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:TextBox ID="HoraInicioTextBox" runat="server" CssClass="timepicker"></asp:TextBox>
    ...
    <asp:TextBox ID="HoraFinTextBox" runat="server" CssClass="timepicker"></asp:TextBox>
