        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                int.TryParse(Session["IdUsuario"].ToString(), out idU);
                    grupos.IdProfesor = idU;
                SemestreDropDownList.DataSource = Semestres.Listar("IdSemestre, Descripcion", " IdProfesor='"+idU+"'");
                ...
                AsignaturaDropDownList.DataSource = Asignaturas.Listar("IdAsignatura, Descripcion", " IdProfesor='" + idU + "'");
