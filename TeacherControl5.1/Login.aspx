<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TeacherControl5._1.Login" %>
        ...
        <div id="contenido">
                ...
                <div id="form">
                	<asp:TextBox ID="UsuarioTextBox" runat="server" CssClass="entradaA" ></asp:TextBox>
                     <br /><asp:TextBox ID="PasswordTextBox" runat="server" CssClass="entradaB" ></asp:TextBox>
                    <div id="check">
