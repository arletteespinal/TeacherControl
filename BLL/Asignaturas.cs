...
namespace BLL
{
    public class Asignaturas
    {
        ...
        {
            return conexion.EjecutarDB("INSERT INTO Asignaturas(CodigoAsignatura,Descripcion,Creditos,IdProfesor)VALUES('" + this.CodigoAsignatura.Replace('\'', '`') + "','" + this.Descripcion.Replace('\'', '`') + "','" + this.Creditos + "','" + this.IdProfesor + "')");
        }
