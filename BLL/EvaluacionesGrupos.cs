    ...
    public class EvaluacionesGrupos
    {
        ...
        public bool Insertar()
        {
            ...
            comando = "INSERT INTO EvaluacionesGrupos (IdGrupo ,IdTipoEvaluacion ,CantidadEvaluaciones)VALUES('" + this.IdGrupo + "','" + this.IdTipoEvaluacion + "','" + this.CantidadEvaluaciones + "');";
                ...
                {
                    comando += "INSERT INTO EvaluacionesGruposDetalle(IdEvaluacionGrupo ,Descripcion,TipoAsignacion ,FechaAsignacion,FechaEntrega,PoderacionEvaluacion,Estatus )VALUES((select max(IdEvaluacionGrupo) as IdEvaluacionGrupo from EvaluacionesGrupos),'" + detalle.Descripcion + "','" + detalle.TipoAsignacion + "','" + detalle.FechaAsignacion + "','" + detalle.FechaEntrega + "','" + detalle.Ponderacion + "','" + detalle.Estatus + "'); ";
                }

                return conexion.EjecutarDB(comando);
        }
        public void agregarDetalle(string Descripcion, string Fecha, string FechaA, int TipoAsignacion, int Ponderacion, int Estatus)
        {
