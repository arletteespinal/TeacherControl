...
namespace BLL
{
    public class Estudiantes
    {
        ...
        {
            return conexion.EjecutarDB("INSERT INTO Estudiantes(IdEstudiante,Matricula,Nombres,Apellidos,Genero,Documento,IdTipoDocumento,Email,Telefono)VALUES('"+this.IdEstudiante +"','"+ this.Matricula + "','" + this.Nombres + "','" + this.Apellidos+"','"+this.Genero + "','" + this.Documento + "','" + this.IdTipoDocumento + "','" + this.Email + "','" + this.Telefono + "')");
        }
